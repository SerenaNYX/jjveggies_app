...
<div class="container">
    ...
    <div class="product-edit-card">
        ...
        @endif
        @if($employee->name == 'Admin User')
            <div>
                <label for="name" class="form-label">Name</label>
                <input type="text" name="name" class="form-control" id="name" value="{{ $employee->name }}" required disabled>
            </div>
            <div>
                <label for="email" class="form-label">Email</label>
                <input type="email" name="email" class="form-control" id="email" value="{{ $employee->email }}" required disabled>
            </div>
            <div>
                <label for="role" class="form-label">Role</label>
                <input type="email" class="form-control" value="{{ $employee->role == 'admin' ? 'Admin' : '' }}" required disabled>
